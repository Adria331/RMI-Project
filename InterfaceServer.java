...
public interface InterfaceServer extends Remote{
	...
	//Lvl parguel
	public void registerClient(String username, String pw, InterfaceClient client) throws RemoteException; //Afegir user a la llista de clients -> server pot notificar a tots a l'hora
